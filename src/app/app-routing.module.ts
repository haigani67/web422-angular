...
import { ArtistDiscograpphyComponent } from './artist-discograpphy/artist-discograpphy.component';
...
const routes: Routes = [
  ...
  { path: 'artist/:id', component: ArtistDiscograpphyComponent,canActivate: [GuardAuthService] },
